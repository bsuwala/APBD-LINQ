...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<Emp> result = Emps.Where(x => x.Salary == Emps.Max(x => x.Salary));
            return result;
        }
        ...
        {
            IEnumerable<object> result = Emps.Select(x => 
            new {
                Nazwisko = x.Ename,
                Praca = x.Job
            });
        ...
        {
            IEnumerable<object> result = Emps.GroupBy(x => x.Job).Take(1).Select(x => new
            {
                Praca = x.Key,
